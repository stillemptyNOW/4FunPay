...
instance_id: int - ID запуска бота.
"""
...
CONFIRM_PASSWORD = "74"
"""
Состояние ожидания повторного ввода пароля перед критичным действием.

Не callback, а состояние пользователя: следующее его сообщение трактуется
как пароль. Само действие хранится в Utils.confirmations.ConfirmationManager
и выполняется только после успешной проверки.
"""
